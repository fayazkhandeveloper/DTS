...
var data = $("#submit_form").serialize();
    ...
    $.ajax({
        type: "POST",
        url: "https://www.clickmop.com/index.php/Company/update_companyvisit",
...
$("#country_list",r).change(function(){r.validate().element($(this))})}}}}();
